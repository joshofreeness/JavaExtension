...
public class TypeVisitor implements VoidVisitor<Object> {
	...
	private void BuiltInTypes(GlobalScope scope){
		
		scope.define(new BuiltInTypeSymbol("int",null));
		scope.define(new BuiltInTypeSymbol("double",null));
		scope.define(new BuiltInTypeSymbol("boolean",null));
		scope.define(new BuiltInTypeSymbol("float",null));
		scope.define(new BuiltInTypeSymbol("byte",null));
		scope.define(new BuiltInTypeSymbol("short",null));
    ...
    public void visit(ClassOrInterfaceDeclaration n, Object arg) {
    	...
    	n.getScopeIn().getEnclosingScope().define((Symbol)n.getScopeIn()); //Define the symbol in the parent scope
